...
public class MsUtil {
    ...
    public static Class<?> getMapperClass(String msId) {
        if (!msId.contains(".")) {
            throw new CommonMapperException("当前 MappedStatement 的id=" + msId + ",不符合MappedStatement的规则!");
        }
        ...
        if (mapperClass == null) {
            throw new CommonMapperException("class loaders failed to locate the class " + mapperClassStr);
        }
