...
import cn.org.ferry.mybatis.providers.EmptyProvider;
import cn.org.ferry.mybatis.providers.MapperTemplate;
...
public class MapperHelper {
    ...
    private MapperTemplate fromMapperClass(Class<?> mapperClass) {
        ...
        for (Method method : methods) {
            ...
            if (templateClass == null) {
                ...
                throw new CommonMapperException("一个通用Mapper中只允许存在一个MapperTemplate子类!");
            }
        }
        ...
        try {
            ...
            throw new CommonMapperException("实例化MapperTemplate对象失败:" + e.getMessage());
        }
        //注册方法
        for (String methodName : methodSet) {
            try {
                ...
                throw new CommonMapperException(templateClass.getCanonicalName() + "中缺少" + methodName + "方法!");
            }
        }
    ...
    public void registerMapper(String mapperClass) {
        try {
            ...
            throw new CommonMapperException("注册通用Mapper[" + mapperClass + "]失败，找不到该通用Mapper!");
        }
    }
    ...
    public void setConfig(Config config) {
        ...
        if(config.getResolveClass() != null){
            try {
                ...
                throw new CommonMapperException("创建 " + config.getResolveClass().getCanonicalName()
        ...
        if (properties != null) {
            ...
            if (StringUtil.isNotEmpty(resolveClass)) {
                try {
                    ...
                    throw new CommonMapperException("创建 " + resolveClass + " 实例失败!", e);
                }
            }
        }
        //注册通用接口
