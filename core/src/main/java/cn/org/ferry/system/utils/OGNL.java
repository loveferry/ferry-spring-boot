...
import cn.org.ferry.system.mybatis.annotation.LogicDelete;
import cn.org.ferry.system.mybatis.entity.EntityColumn;
import cn.org.ferry.system.mybatis.entity.Example;
import cn.org.ferry.system.mybatis.entity.IDynamicTableName;
import cn.org.ferry.system.mybatis.helper.EntityHelper;
...
public abstract class OGNL {
    ...
    public static boolean checkExampleEntityClass(Object parameter, String entityFullName) {
        if (parameter != null && parameter instanceof Example && StringUtils.isNotEmpty(entityFullName)) {
            ...
            if (!entityClass.getCanonicalName().equals(entityFullName)) {
                throw new MybatisException("当前 Example 方法对应实体为:" + entityFullName
    ...
    public static boolean notAllNullParameterCheck(Object parameter, String fields) {
        if (parameter != null) {
            try {
                ...
                throw new MybatisException(SAFE_DELETE_ERROR, e);
            }
        }
        throw new MybatisException(SAFE_DELETE_EXCEPTION);
    }
    ...
    public static boolean hasCountColumn(Object parameter) {
        if (parameter != null && parameter instanceof Example) {
            Example example = (Example) parameter;
            return StringUtils.isNotEmpty(example.getCountColumn());
        }
        return false;
    }
