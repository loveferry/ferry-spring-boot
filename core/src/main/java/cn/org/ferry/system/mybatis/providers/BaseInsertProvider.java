...
import cn.org.ferry.system.mybatis.helper.SelectKeyHelper;
        ...
        for (EntityColumn column : columnList) {
            if (column.isIdentity()) {
                ...
                if (hasIdentityKey) {
                    ...
                    throw new MybatisException(ms.getId() + "对应的实体类" + entityClass.getCanonicalName() + "中包含多个MySql的自动增长列,最多只能有一个!");
                }
                //插入selectKey
